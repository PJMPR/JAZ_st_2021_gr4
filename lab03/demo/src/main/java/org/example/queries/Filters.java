...
import org.example.queries.criteria.filters.*;
import org.example.queries.criteria.operations.AndCriteria;
import org.example.queries.criteria.operations.OrCriteria;
...
public class Filters {
    ...
    public void filterData(Results result) {
        List<Criteria> criteria  = List.of(
                ...
                new SurnameCriteria(parameters.getSurname())
        );
        criteria.forEach(c -> {
    ...
    public Filters(SearchParameters parameters) {
